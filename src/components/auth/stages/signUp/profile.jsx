...
export default function AuthSignUpProfile({ avatar, setAvatar }) {
	...
	return (
		<>
			<div style={{ borderColor: colors.textPrimaryTransparent }} className={`w-32 ${avatar ? "" : "border-2"} relative border-dashed rounded-full justify-center items-center flex h-32`}>
