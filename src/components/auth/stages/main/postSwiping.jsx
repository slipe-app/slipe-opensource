	...
	return (
		<>
			<div className='w-full flex justify-center items-center relative'>
				<Image width={192} height={288} src='./postsExamples/skibidi.jpg' className='rounded-[1.75rem] scale-[0.825] -rotate-12 mr-40 brightness-50 absolute mb-3' />
				<Image width={192} height={288} src='./postsExamples/s&m.png' className='rounded-[1.75rem] scale-[0.825] rotate-12 ml-40 brightness-50 absolute mb-3' />
